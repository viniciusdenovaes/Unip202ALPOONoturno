...
public class JanelaComboBox extends javax.swing.JFrame {
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        System.out.println("combo box usado");
        System.out.println(this.jComboBox1.getSelectedItem());
        Object itemSelecionado = this.jComboBox1.getSelectedItem();
        String valor = itemSelecionado.toString();
        System.out.println("A string selecionada eh " + valor);
        switch(valor){
            case "Item 1": 
